...
#2．关键字可变参数 这种更加灵活 **
#字典中的键为参数名，值为响应的参数值！
def fun2(arg1,arg2='xx',**theRest):  #星号之后的所有形参将作为字典the Rest传递给函数，
    print 'arg1:',arg1
    print 'arg2:',arg2
    for arg in theRest:
...
dict1={3:4,'3':5,2:545}
fun2(3,dict1)  #放在外面  #这里不懂 为什不能是fun2(3,9,dict1) 遗留问题
